...
### 핵심 컨셉: Plome (Plant My Forest Home)
저축 활동을 **'집나무 숲 가꾸기'**로 게이미피케이션하여, 지루한 저축 과정을 즐거운 경험으로 전환합니다.
...
- **레벨업 기준**:
  ...
  - Lv 4: 500 EXP (전문가)
  - Lv 5: 1000 EXP (집나무 숲지기)

---

### [P0] REQ-6.2 집나무 수집
**설명**: 특정 조건 달성 시 집나무 획득 (4계절 × 2레벨 = 8종)
...
**제약조건**:
- **집나무 구조**: 4계절 × 2레벨 = 8종
  - **봄**: 벚꽃지붕 집나무 (COMMON), 벚꽃정원 집나무 (RARE)
  - **여름**: 잔디벽 집나무 (COMMON), 야자수 집나무 (RARE)
  - **가을**: 단풍 테라스 집나무 (COMMON), 황금 집나무 (RARE)
  - **겨울**: 눈굴뚝 집나무 (COMMON), 크리스탈 집나무 (RARE)
- **획득 조건 예시**:
  - 첫 저축: 봄 벚꽃지붕 집나무 (COMMON)
  - 레벨 2 달성: 여름 잔디벽 집나무 (COMMON)
  - 레벨 3 + 100만원 저축: 가을 단풍 테라스 집나무 (COMMON)
  - 총 500만원 저축: 봄 벚꽃정원 집나무 (RARE)
- 동일 집나무 중복 획득 시 `tree_level` 증가
- `is_displayed_in_forest=TRUE`인 집나무만 숲에 표시
...
**출력**:
- 집나무 숲 렌더링 (WebP 애니메이션)

**제약조건**:
- `is_displayed_in_forest=TRUE`인 집나무만 표시
...
| **게이미피케이션** | 집나무 수집 | house_trees, user_house_trees |
...
| **게이미피케이션** | 집나무 숲 관리 | user_house_trees |
