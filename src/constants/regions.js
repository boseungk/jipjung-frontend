/**
 * Korean Regional Data
 * 
 * Complete list of 시/도 (Sido) and 구/군 (Sigungu) for
 * location selection in the onboarding flow.
 */

/**
 * List of all 시/도 (provinces/metropolitan cities)
 */
...
/**
 * Map of 시/도 to their 구/군 (districts)
 */
...
/**
 * Get list of sigungu for a given sido
 * @param {string} sido - The sido name
 * @returns {string[]} Array of sigungu names
 */
...
/**
 * Validate if a region selection is valid
 * @param {string} sido - The sido name
 * @param {string} sigungu - The sigungu name
 * @returns {boolean} True if valid combination
 */
export function isValidRegion(sido, sigungu) {
    const sigunguList = getSigunguList(sido)
    return sigunguList.includes(sigungu)
}

/**
 * Format region for display
 * @param {Object} region - Region object with sido and sigungu
